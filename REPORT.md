...
4. **Encapsulation**: Private attributes (attributes are marked as **private** using double underscores (`_ _`), preventing direct external access. Access is controlled through **getter methods** using `@property` decorators).
### Design patterns
